...
def init():
    ...
    Buys_Qty = [0.05, 0.05, 0.06, 0.06, 0.07, 0.07, 0.08, 0.08, 0.09, 0.09, 0.1, 0.1, 0.11, 0.11]
    ...
    Buy_multiplication_list = [1, 1.4, 1.6, 1.8, 2, 2.2, 2.5, 2.8, 3.1, 3.1, 3.3, 3.3, 3.3, 3.3]
    Sell_multiplication_list = [1, 1.2, 1.4, 1.8, 2.2, 2.4, 2.6, 2.8, 2.9, 3, 3.1, 3.5, 4, 4]
    Agressivity = 1
    Last_Agressivity = 1
